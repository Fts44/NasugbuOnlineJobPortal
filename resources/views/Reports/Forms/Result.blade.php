            ...
            <tr>
                <td colspan="50" class="l nb">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                     ...
                     @if($d->ja_result == 1)
                        have passed the interview last {{ date_format(date_create($d->ja_datetime),'F d, Y') }}. Please wait for further details as we prepare your job offer. Congratulations.
                     @else
                        didn't passed the interview last  {{ date_format(date_create($d->ja_datetime),'F d, Y') }}. Thank you for your interest in joining {{ $d->biz_name }}. We wish you all the best in your job search. Thank you.
                     @endif 
                </td>
            </tr>
            <tr>
