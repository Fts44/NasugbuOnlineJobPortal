...
@section('content')
    <section class="main">
		<div class="login-container">
			<p class="title">O-JoFi: Register</p>
        	<div class="separator"></div>
        	<p class="welcome-message">An Online Job Finder Platform exclusive for Nasugbueños.</p>

        	<form class="login-form mt-2" method="POST" action="{{ route('Register') }}">
                @csrf
                ...
                <div class="text-danger px-3 form-control border-0 p-0">
                    @error('user_type')
                        {{ $message }}
                    @enderror
                </div>
                ...
                <button id="btnProceed" class="submit btn btn-secondary my-4">Register</button>
            </form>
