<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="col-lg-2 ms-2" id="search-bar">
        <div class="input-group input-group-sm">
            <div class="input-group-append">
                <button class="btn btn-secondary btn-sm" type="button" id="filter-job-post">
                    <i class="bi bi-funnel"></i>
                </button>
                <button class="btn btn-secondary btn-sm" type="button" id="add-job-post">
